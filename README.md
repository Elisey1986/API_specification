---
{
  "openapi" : "3.0.0",
  "info" : {
    "title" : "API системы управления автоматизации роботов \"Робот и точка\"",
    "version" : "01.12",
    "description" : "Спецификация разработана в рамках курсового проекта по курсу \"Системный аналитик.Advanced\" в Otus. Данный пример предназначен для системы управления автоматизации роботов и настройка меню и технологических карт \"Робот и точка\".",
    "contact" : {
      "name" : "Elisey Bauer",
